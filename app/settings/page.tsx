        ...
        return (
            <div className="flex h-screen w-full flex-col items-center justify-center bg-black text-white gap-4">
                ...
                <div className="flex gap-4">
                    <a href="/api/auth/login" className="px-6 py-2 bg-cyan-900/30 border border-cyan-500/50 rounded text-cyan-400 hover:bg-cyan-500/20 transition-colors">LOGIN</a>
                </div>
            </div>
        );
    }
